...
create_generated_clock -source {vgaText_inst|clkGen|altpll_component|auto_generated|pll1|inclk[0]} -divide_by 50 -multiply_by 63 -duty_cycle 50.00 -name baseClk {vgaText_inst|clkGen|altpll_component|auto_generated|pll1|clk[0]}
